...
public interface ExerciseUseCase {
        ...
        Exercise create(String nameFR, String description, String linkVideo, Long idUser,
                        List<MuscleInsertExercice> muscles);

        Exercise update(Long idExercice, Long idUserQuiModifie, String nameFR, String description, String linkVideo,
                        List<MuscleInsertExercice> relExerciseMuscles);

        void delete(Long idExercice, Long idUser);
}
