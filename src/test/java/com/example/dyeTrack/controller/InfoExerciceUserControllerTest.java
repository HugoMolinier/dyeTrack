...
public class InfoExerciceUserControllerTest {
        ...
        void testUpdateInfo_createNewInfo_success() throws Exception {
                ...
                ReturnInfoExerciceUserDTO result = TestUtils.assertAndExtractData(response, null, objectMapper,
                                ReturnInfoExerciceUserDTO.class);
        ...
        void testGetAllInfoOfUser_success() throws Exception {
                ...
                List<ReturnInfoExerciceUserDTO> list = TestUtils.assertAndExtractDataList(response,
                                "Liste des exercices utilisateur récupérée avec succès", objectMapper,
                                ReturnInfoExerciceUserDTO.class);
        ...
        void testGetAll_otherUserHasNoInfo() throws Exception {
                ...
                List<ReturnInfoExerciceUserDTO> infos = TestUtils.assertAndExtractDataList(response,
                                "Liste des exercices utilisateur récupérée avec succès", objectMapper,
                                ReturnInfoExerciceUserDTO.class);
